...
void twxChangePhysicsStepsPerSecond(float accuracy, void*); // function to change simulation accuracy

void twxChangeERPCFM(float notUsed, void*); // function to change ERP/CFM appropriately

void twxChangeSolverIterations(float notUsed, void*); // change the solver iterations

void twxChangeFPS(float fpsPerSecond, void*); // change frames per second

void clampToCustomSpeedNotches(float speed, void*); // function to clamp to custom speed notches
...
void setApplicationTick(float frequency, void*); // set internal application tick
...
void twxChangePhysicsStepsPerSecond(float physicsStepsPerSecond, void*) { // function to change simulation physics steps per second
	if (twx){
		twx->changePhysicsStepsPerSecond(physicsStepsPerSecond);
	}
}

void twxChangeFPS(float fpsPerSecond, void*) {
	if(twx){
